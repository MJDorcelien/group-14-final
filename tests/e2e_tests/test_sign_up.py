...
def test_signup_page_loads_correctly(test_app: FlaskClient):
...
def test_signup_page_contains_signup_form(test_app: FlaskClient):
    # Make a request to the sign up page
    response = test_app.get("/signup")
...
def test_signup_page_contains_username_input_field(test_app: FlaskClient):
    # Make a request to the sign up page
    response = test_app.get("/signup")
...
def test_signup_page_contains_password_input_field(test_app: FlaskClient):
    # Make a request to the sign up page
    response = test_app.get("/signup")
...
def test_signup_page_contains_signup_button(test_app: FlaskClient):
    # Make a request to the sign up page
    response = test_app.get("/signup")
...
def test_signup_page_contains_login_link(test_app: FlaskClient):
    # Make a request to the sign up page
    response = test_app.get("/signup")
...
def test_email_input_field(test_app: FlaskClient):
    # Make a request to the sign up page
    response = test_app.get("/signup")
...
def test_bio_input_field(test_app: FlaskClient):
    # Make a request to the sign up page
    response = test_app.get("/signup")
