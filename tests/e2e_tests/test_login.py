...
def test_page_loads_correctly(test_app: FlaskClient):
...
def test_page_contains_login_form(test_app: FlaskClient):
    # Make a request to the login page
    response = test_app.get("/login")
...
def test_page_contains_username_input_field(test_app: FlaskClient):
    # Make a request to the login page
    response = test_app.get("/login")
...
def test_page_contains_password_input_field(test_app: FlaskClient):
    # Make a request to the login page
    response = test_app.get("/login")
...
def test_page_contains_login_button(test_app: FlaskClient):
    # Make a request to the login page
    response = test_app.get("/login")
...
def test_page_contains_signup_link(test_app: FlaskClient):
    # Make a request to the login page
    response = test_app.get("/login")
